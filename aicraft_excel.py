...
def parse_data(url):
    ...
    for item in tree.xpath('//*[contains(@class, "listing-item")]'):
            ...
            links.append(link)
    return titles, prices, years, serial_numbers, total_times, locations, dealers, links


def output(i, titles, prices, years, serial_numbers, total_times, locations, dealers, links):
    ...
    output.to_excel(writer, sheet_name='Sheet1', startrow=i)

    output(titles, prices, years, serial_numbers, total_times, locations, dealers, links)




    """for item in tree.xpath('//*[contains(@class, "wanted")]'):
